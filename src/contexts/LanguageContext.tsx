...
const translations: Record<Language, Record<string, string>> = {
    de: {
        ...
        "pmu.faq_q1": "Warum sollte ich euch wählen?",
        ...
        "pmu.faq_a5": "Bei der Beratung informieren wir nicht nur über mögliche Risiken, sondern analysieren auch ehrlich, ob deine Wünsche und Erwartungen realistisch und umsetzbar sind. Wir beraten offen und transparent, damit du keine falschen Erwartungen hast und kein Geld unnötig ausgibst.",
        ...
        "headspa.pkg2_name": "Headspa Essential (60 Min.)",
        ...
        "headspa.pkg3_name": "Headspa Deluxe (90 Min.)",
        ...
        // Schulung Page
        "schulung.hero_title": "Deine Beauty-Karriere",
        "schulung.hero_title2": "15 Jahre Vorsprung ab Tag 1!",
        "schulung.hero_desc": "Wir lehren dich das Handwerk und das komplette System dahinter. Sichern dir einen krisensicheren Beruf, der dir langfristige Stabilität und echte Karrierechancen bietet. Keine Umwege, nur echte Praxis.",
        ...
        "schulung.b2_desc": "Wir zeigen dir genau, was du wirklich brauchst. Vermeide 100% typische Anfängerfehler.",
        ...
        "schulung.b5_desc": "Wir unterstützen dich bei der Jobsuche oder deiner Gründung.",
        "schulung.b6_title": "Unser Versprechen",
        "schulung.b6_desc": "Wir haben die Fehler der letzten 15 Jahre gemacht, damit DU sie nicht machen musst.",
        "schulung.courses_title": "Unsere Kurse",
        "schulung.courses_desc": "Wähle den Kurs, der zu deinen Zielen passt. Wir beraten dich persönlich und erstellen eine Route, die auf deine Lebenssituation und dein Investment zugeschnitten ist.",
        ...
        "schulung.selfstudy_1": "Selbststudium kosten dich Zeit, Kunden und deinen Ruf.",
        "schulung.selfstudy_2": "Zwei Stunden pro Behandlung? Kein rentables Business.",
        "schulung.selfstudy_3": "Ohne Struktur und Tempo kannst du gegen erfahrene Studios nicht bestehen.",
        "schulung.selfstudy_4": "Eine Profi-Ausbildung macht dich konkurrenzfähig – von Anfang an",
        "schulung.faq_title": "FAQ – Häufig gestellte Fragen",
        "schulung.faq_q1": "Warum ein Handwerk?",
        "schulung.faq_a1": "Weil du damit die volle Kontrolle über dein Leben hast: KI-sicher (Handwerk ist echte Kunst), krisensicher (keine Angst vor Kurzarbeit), flexibel für die Familie, finanzielles Plus als Zusatzeinkommen, und überall gefragt mit deinem Zertifikat.",
