...
export default function KopfhautPflegePage() {
    ...
    const [heroTitle] = useState("PROFESSIONELLE KOPFHAUT/HAUTPFLEGE");
            ...
            <section className="pt-44 pb-4">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h1 className="text-[#ff8b69] text-xl sm:text-2xl md:text-4xl font-bold uppercase tracking-wide">
                        <span className="block sm:inline">PROFESSIONELLE</span>{" "}
                        <span className="block sm:inline">KOPFHAUT/</span>
                        <span className="block sm:inline">HAUTPFLEGE</span>
                    </h1>
                </div>
            </section>
