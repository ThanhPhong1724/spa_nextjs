...
export default function NailsClient({ content }: { content?: any }) {
    const [openFaq, setOpenFaq] = useState<number | null>(null);
    const { t } = useLanguage();

    const heroTitle = content?.hero?.title_de || "NAILS";
    const nagelImage = content?.service_images?.nagelmodellage_image || "";
    const fusspflegeImage = content?.service_images?.fusspflege_image || "";
