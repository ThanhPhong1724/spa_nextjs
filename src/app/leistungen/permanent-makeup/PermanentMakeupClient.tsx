...
export default function PermanentMakeupPage({ content: pageContent }: { content?: any }) {
    const [openFaq, setOpenFaq] = useState<number | null>(null);
    const { language, t } = useLanguage();

    const infoSheetImageDe = pageContent?.info_sheet?.image || "/images/permanent-makeup-info.jpg";
    ...
    const heroTitle = pageContent?.hero?.title_de || "PERMANENT MAKE UP";
    const videoUrl = pageContent?.hero?.video_url || "https://cdn.pixabay.com/video/2020/05/25/40130-424930032_large.mp4";
    const browsImage = pageContent?.service_images?.brows_image || "https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?w=600&h=400&fit=crop";
    const lipsImage = pageContent?.service_images?.lips_image || "https://images.unsplash.com/photo-1596704017254-9b121068fb31?w=600&h=400&fit=crop";
    const eyesImage = pageContent?.service_images?.eyes_image || "https://images.unsplash.com/photo-1583001931096-959e9a1a6223?w=600&h=400&fit=crop";
