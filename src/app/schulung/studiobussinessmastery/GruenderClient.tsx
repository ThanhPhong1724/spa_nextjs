...
const benefits = [
    {
        ...
        description: "Sie erhalten <strong>eine kostenlose Website</strong> sowie <strong>15 fertige Social-Media-Posts</strong>, damit Sie sofort professionell sichtbar sind."
    },
    {
        icon: <ChartIcon />,
        title: "Maßgeschneiderte Strategieplanung",
        description: "Wir erstellen mit Ihnen einen konkreten Businessplan, der exakt auf Ihre persönlichen Ziele und Ihr verfügbares Investitionskapital zugeschnitten ist."
    },
    {
        icon: <CurrencyIcon />,
        title: "Maximale Kostenersparnis",
        description: "Erfahren Sie, wie Sie Ihre Buchhaltung auch ohne Vorkenntnisse selbst organisieren und dabei bis zu 250 € pro Monat an Steuerberatergebühren sparen können."
    },
    {
        icon: <DeviceIcon />,
