            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex h-24 items-center justify-between">
                    ...
                    <Link href="/" className="flex items-center gap-3 group">
                        <div className={`flex items-center justify-center w-12 h-12 rounded-full transition-colors ${isTransparent ? "bg-white/20" : "bg-[#ff8b69]/10"}`}>
                            <span className={`material-symbols-outlined !text-3xl ${isTransparent ? "text-white" : "text-[#ff8b69]"}`}>spa</span>
                        </div>
                        <div className="flex flex-col">
                            <h1 className={`text-2xl font-bold tracking-tight leading-none ${textColorClass}`}>
                                Smiling
                            </h1>
                            <span className={`text-[0.65rem] uppercase tracking-widest font-bold ${textColorClass}`}>
                                Studio
                            </span>
                        </div>
                    </Link>
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <a
                            ...
                            className={`lg:hidden w-10 h-10 flex items-center justify-center rounded-full transition-colors ${isTransparent ? "bg-white/20 text-white" : "bg-[#ff8b69]/10 text-[#ff8b69]"}`}
                        >
                        ...
                        {/* Mobile Menu Button */}
                        <button
                            className={`lg:hidden p-2 rounded-lg transition-colors ${textColorClass} hover:bg-black/5`}
