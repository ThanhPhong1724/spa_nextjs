...
export default function Footer({ content }: { content?: any }) {
    ...
    return (
        <footer className="bg-[#ff8b69] text-white">
            {/* Main Footer */}
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {/* Column 1: Kontakt */}
                    <div>
                        <h3 className="text-white font-bold text-lg uppercase tracking-wide mb-6">
                            {t("footer.contact")}
                        </h3>
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-white/90">
                            <div className="flex items-start gap-3">
                                <span className="material-symbols-outlined text-white mt-0.5">schedule</span>
                                <div>
                    ...
                    <div>
                            ...
                            {socials.map((social) => {
                                ...
                                return (
                                    <a
                                        ...
                                        className="w-11 h-11 rounded-full bg-white/20 flex items-center justify-center text-white hover:bg-white hover:text-[#ff8b69] transition-all"
                                    >
                                        {social.icon}
                                    </a>
                                );
                        ...
                        <div className="flex flex-wrap gap-3 text-sm text-white/90">
                            <span className="flex items-center gap-2 bg-white/20 px-3 py-1.5 rounded-full border border-white/20">
